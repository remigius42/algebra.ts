...
describe("Complex number initialization", function(){
    ...
    it("should throw an error if initialized with an integer for the real part", function() {
        expect(function(){new Complex(2, new Fraction(3, 1));}).toThrow(new TypeError("Invalid Argument (2, 3): Real and imaginary parts must be of type Fraction."));
    });

    it("should throw an error if initialized with an integer for the imaginary part", function() {
        expect(function(){new Complex(new Fraction(3, 1),2);}).toThrow(new TypeError("Invalid Argument (3, 2): Real and imaginary parts must be of type Fraction."));
    });
...
describe("Complex number addition", function() {
    ...
    it("does not work with adding floats", function() {
        expect(function(){c.add(0.1);}).toThrow(new TypeError("Invalid Argument (0.1): Summand must be of type Complex, Fraction or Integer."));
    });
...
describe("Complex number subtraction", function() {
    ...
    it("does not work with subtracting floats", function() {
        expect(function(){c.subtract(0.1);}).toThrow(new TypeError("Invalid Argument (0.1): Subtrahend must be of type Complex, Fraction or Integer."));
    });
...
describe("Complex number multiplication", function() {
    ...
    it("does not work with multiplying floats", function() {
        expect(function(){c.multiply(0.1);}).toThrow(new TypeError("Invalid Argument (0.1): Multiplicand must be of type Complex, Fraction or Integer."));
    });
...
describe("Complex number division", function() {
    ...
    it("does not work with floats", function() {
        expect(function(){c.divide(0.1);}).toThrow(new TypeError("Invalid Argument (0.1): Divisor must be of type Complex, Fraction or Integer."));
    });
