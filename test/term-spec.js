...
describe("Terms", function() {
    ...
    it("can't be initialized with an integer", function() {
        expect(function(){new Term(5);}).toThrow(new TypeError("Invalid Argument (5): Term initializer must be of type Variable."));
    });

    it("can't be initialized with a float", function() {
        expect(function(){new Term(5.1);}).toThrow(new TypeError("Invalid Argument (5.1): Term initializer must be of type Variable."));
    });

    it("can't be initialized with a string", function() {
        expect(function(){new Term("x");}).toThrow(new TypeError("Invalid Argument (x): Term initializer must be of type Variable."));
    });
});
...
describe("Term addition", function() {
    ...
    it("throws an error if trying to combine unlike terms", function() {
        ...
        expect(function(){t1.add(t2);}).toThrow(new TypeError("Invalid Argument (y): Summand must be of type String, Expression, Term, Fraction or Integer."));
    });
});
...
describe("Term subtraction", function() {
    ...
    it("throws an error if trying to combine unlike terms", function() {
        ...
        expect(function(){t1.subtract(t2);}).toThrow(new TypeError("Invalid Argument (y): Subtrahend must be of type String, Expression, Term, Fraction or Integer."));
    });
});
...
describe("Term multiplication", function() {
    ...
    it("doesn't allow multiplication of floats", function() {
        ...
        expect(function(){t.multiply(0.5);}).toThrow(new TypeError("Invalid Argument (0.5): Multiplicand must be of type String, Expression, Term, Fraction or Integer."));
    });
...
describe("Term division", function() {
    ...
    it("doesn't allow division of floats", function() {
        ...
        expect(function(){t.divide(0.5);}).toThrow(new TypeError("Invalid Argument (0.5): Argument must be of type Fraction or Integer."));
    });
